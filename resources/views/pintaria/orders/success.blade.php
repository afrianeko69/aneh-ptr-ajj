...
<div class="c-content-box c-size-md c-bg-white">
    <div class="container">
        <div class="c-content-title-1">
            <h3 class="c-center c-font-dark c-font-uppercase"> <img src="{{ asset('pintaria/img/shared/check1.png') }}"> {{$title}}</h3>
        </div>
        
        <div class="c-content-panel">
            <div class="c-body">
                <center>{!!$description!!}<br>
                    <a href="{{route('kelas.saya')}}" class="btn c-btn btn-lg c-font-bold c-font-white c-theme-btn c-btn-square">Kelas Saya</a><br><br>
