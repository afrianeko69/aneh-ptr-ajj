...
@section('title'){{ (!empty($news->seo_title) ? $news->seo_title : 'Pintaria - Portal Edukasi Indonesia') }}@endsection 

@section('meta_description'){{ (!empty($news->meta_description) ? $news->meta_description : '') }}@endsection 
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="bloglist singlepost">
                <p><img alt="" class="img-fluid" src="{{ asset_cdn($news->image) }}"></p>
                <h1>{{ $news->title }}</h1>
