...
@section('title')
    Kuliah S1 Kelas Karyawan Campuran Offline & Online. Daftar sekarang!
@endsection
...
<meta property="og:description" content="Mau raih gelar sarjana meskipun sibuk bekerja? Kenapa nggak! Yuk daftar kuliah blended learning Pintaria sekarang juga. Pilih kampus yang kamu mau, cicilan mulai dari Rp 700 ribuan/bulan! Gunakan kode referral saya untuk mendapatkan kesempatan memenangkan hadiah voucher belanja senilai Rp 500 ribu! Gunakan di sini.">
...
<meta name="twitter:description" content="Raih gelar sarjana sambil kerja? Di Pintaria, bisa! Gunakan kode referral dari saya dan dapatkan hadiah senilai 500 ribu. Gunakan di sini.">
...
<meta itemprop="description" content="Mau raih gelar sarjana meskipun sibuk bekerja? Kenapa nggak! Yuk daftar kuliah blended learning Pintaria sekarang juga. Pilih kampus yang kamu mau, cicilan mulai dari Rp 700 ribuan/bulan! Gunakan kode referral saya untuk mendapatkan kesempatan memenangkan hadiah voucher belanja senilai Rp 500 ribu! Gunakan di sini.">
@endsection
...
@section('content')
    ...
    <section class="top-banner" style="padding: 0">
        <div class="container w-960">
            ...
            <h2 class="title-banner-text white-text font32">DAPATKAN GELAR SARJANA <br/> SAMBIL BEKERJA</h2>
            ...
            <div class="info-form" id="mohon-info" style="position: relative">
                ...
                <form action="{{ route('submit.hubungi.kami.kuliah') }}" method="post" class="landing_form">
                    {{ csrf_field() }}
        ...
        <div class="container w-960">
            ...
            <div class="row">
                ...
                <div class="col-md-4 center item">
                    <div class="box_grid">
                        ...
                        <div class="wrapper no-clip">
                            <h3 class="font-bold">Universitas Mohammad Husni Thamrin (UMHT)</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row" style="justify-content: center">
                <div class="col-md-4 center item">
                    <div class="box_grid">
                        <figure class="no-clip">
                            <img src="{{asset_cdn('pintaria/landing-pages/Pintaria-upj.jpg')}}">
                        </figure>
                        <div class="wrapper no-clip">
                            <h3 class="font-bold">Universitas Pembangunan Jaya (UPJ)</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 center item">
    ...
    <section class="dark-grey-bg center">
        <p class="center font22 white-text w70-percent m-auto">Daftar sampai <span class="font-bold">17 Agustus 2018</span> & dapatkan diskon hingga <span class="font-bold">35%</span>
            <br/> untuk cicilan biaya kuliah pertama! Hubungi kami sekarang!</p>
