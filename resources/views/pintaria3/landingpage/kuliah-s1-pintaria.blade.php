...
@push('additional.style')
    <style type="text/css">
        ...
        .top-banner {
            /* The image used */
            background: url("{{asset_cdn('pintaria/landing-pages/s1-pintaria-header-2.jpg')}}") center center no-repeat;
        ...
        @media (max-width: 768px){
            ...
            .top-banner{
                background: url("{{asset_cdn('pintaria/landing-pages/s1-pintaria-header-m-2.jpg')}}") center center no-repeat;
                height: 600px;
                min-height: 0;
                background-size: cover;
            }
...
@section('content')
    ...
    <section class="top-banner s1" style="padding: 0">
        <div class="container w-960 banner-c">
            <h1 class="logo pb-1">
            ...
            <h2 class="title-banner-text white-text font24 text-left font-bold m-auto">
    ...
    <section class="main_description orange-bg pb-5">
        <div class="container w-960">
            ...
            <p class="blended-desc white-text center w70-percent m-auto">
                ...
                <div class="col-md-4 center mt-2 mb-2">
                    <div class="feature-kuliah">
                        ...
                        <div class="desc">
                            ...
                            <p>
                                Jadwal kuliah yang lebih fleksibel. Belajar secara <span class="font-italic">online</span> di mana saja dan kapan
                                saja.
                            </p>
                        </div>
                    </div>
            ...
            <div class="row mt-5 light-dark-color d-none">
        ...
        <div class="container w-960">
            ...
            <div class="row s1-testimony pt-5">
                <div class="col-md-6">
                    <div class="item">
                        <figure class="pic">
                            <img class="img-fluid" src="{{ asset_cdn('pintaria/landing-pages/t_Astri-Annisa.png') }}">
                        </figure>
                        <div class="content font12">
                            <p class="mb-2">
                                Alasan saya memilih blended learning, karena efisiensi waktu
                                yang mempermudah waktu kerja dan waktu kuliah
                            </p>
                            <p class="mb-0">
                                <span class="font-bold">Astri Annisa</span><br>
                                Mahasiswi UAI <span class="font-italic">Blended Learning</span>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="item">
                        <figure class="pic">
                            <img class="img-fluid" src="{{ asset_cdn('pintaria/landing-pages/t_istiqoma.png') }}">
                        </figure>
                        <div class="content font12">
                            <p class="mb-2">
                                Pekerjaan tetap jalan, kuliah pun nyaman karena meski berlangsung online,
                                ada juga sepekan sekali interaksi dengan kawan-kawan dan dosen.
                            </p>
                            <p class="mb-0">
                                <span class="font-bold">Istiqomah</span><br>
                                Mahasiswi USAHID <span class="font-italic">Blended Learning</span>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="pt-5 pb-5 gray-bg">
        <div class="container w-960">
            <h2 class="font24 mb-4 capitalize center light-dark-color font-bold">Perguruan Tinggi Berkualitas</h2>
            <div class="row pt-1" style="justify-content: center">
                <div class="col-md-5 center item">
                    <div class="box_grid">
                        <figure class="no-clip">
                            <img src="{{asset_cdn('pintaria/landing-pages/UAI-2.jpg')}}">
                        </figure>
                        <div class="wrapper no-clip">
                            <div class="content">
                                <h3 class="font-bold">Universitas Al-Azhar Indonesia (UAI)</h3>
                                <span class="font-bold">Jakarta Selatan</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-5 center item">
                    <div class="box_grid">
                        <figure class="no-clip">
                            <img src="{{asset_cdn('pintaria/landing-pages/Usahid-Jakarta.jpg')}}">
                        </figure>
                        <div class="wrapper no-clip">
                            <div class="content">
