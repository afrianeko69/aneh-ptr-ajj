...
@section('title')
Kursus Online Data Science Diskon 50% Periode 25 - 31 Maret 2018 | Pintaria @endsection
...
<style type="text/css">
.top-banner {
  background: url("{{asset_cdn('pintaria/landing-pages/slider-DS.jpg')}}") center center no-repeat;
...
@media(max-width: 768px) {
    .top-banner {
        background: url("{{asset_cdn('pintaria/landing-pages/slider-mobile.jpg')}}") center center no-repeat #0c0d12;
        height: 300px;
...
<section class="top-banner">
    ...
    <div class="banner-text">
        <p class="font35 font-bold">
            @if($product->is_discount)
                <span class="font25 line-through font-normal">{{ $product->formatted_price }}</span> 
        ...
        <p class="font25">
            <span class="uppercase">kelas data science diskon 50%</span><br/>
            Periode pendaftaran 25-31 Maret 2018
        </p>
    </div>
</section>
<section>
    <div class="container">
        <h2 class="capitalize font25 center">mengapa penting untuk mengikuti program ini</h2>
        <div class="row">
            <div class="col-md-3">
                <div class="feature-part">
                    <img src="{{url('pintaria3/img/1.png')}}">
                    <p class="font18">
            ...
            <div class="col-md-3">
                <div class="feature-part">
                    <img src="{{url('pintaria3/img/2.png')}}">
                    <p class="font18">
            ...
            <div class="col-md-3">
                <div class="feature-part">
                    <img src="{{url('pintaria3/img/3.png')}}">
                    <p class="font18">
            ...
            <div class="col-md-3">
                <div class="feature-part">
                    <img src="{{url('pintaria3/img/4.png')}}">
                    <p class="font18">
...
<section class="light-blue-bg">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h2 class="font25">Sukses Berkarir di Dunia Data Science</h2>
                <p class="font18">
                    Data Science and Technology Series adalah program online bagi siapa saja yang ingin mempelajari mengenai data science dan berbagai macam teknologi di bidang data. Dengan mengikuti kursus online ini, Anda akan mendapatkan pengetahuan dan keterampilan yang dapat membantu Anda meniti karir sebagai <strong>Data Analyst</strong>, <strong>Data Engineer</strong>, atau <strong>Data Scientist.</strong>
                </p>
            </div>
            <div class="col-md-4">
                <div class="box_detail">
                    <div class="discount center font35 font-bold">50%<br/><span class="font18 font-normal">OFF</span></div>
                    <figure>
                        @if($product->youtube_video_id)
                            <a href="{{ $product->youtube_url }}" class="video">
                    ...
                    <a href="{{ route('home.global.search', [App\Product::KEYWORD => 'data science']) }}" class="btn_2 full-width">Beli Sekarang</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="cta">
    <div class="container">
        <h2 class="font-bold font30">Kelas Data Science DISKON 50%</h2>
        <a href="{{ route('home.global.search', [App\Product::KEYWORD => 'data science']) }}" class="btn_2 right btn-buy-now-2">Beli Sekarang</a>
    </div>
</div>
