                ...
                <div class="panel panel-bordered">
                    ...
                    <form class="form-edit-add" role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="role">Affiliate</label>
                                <select name="affiliate_id" id="role" class="form-control">
                                    <option></option>
                                    <?php $affiliates = App\Affiliate::all(); ?>
                                    @foreach($affiliates as $affiliate)
                                        <option value="{{$affiliate->id}}" @if(isset($dataTypeContent) && $dataTypeContent->affiliate_id == $affiliate->id) selected @endif>{{$affiliate->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div><!-- panel-body -->
