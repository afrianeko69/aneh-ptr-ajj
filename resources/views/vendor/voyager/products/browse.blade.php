...
@section('content')
    <div class="page-content container-fluid">
        @include('vendor.voyager.notification')
                                ...
                                <tr>
                                    ...
                                    <td class="no-sort no-click" id="bread-actions">
                                        ...
                                        @if (Voyager::can('read_'.$dataType->name))
                                            <a href="{{ route('voyager.'.$dataType->slug.'.show', $data->id) }}" title="View" class="btn btn-sm btn-warning pull-right ml-5">
                                                <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">View</span>
                                            </a>
                                        @endif
                                        @if (
                                            $data->isOfflineCourse() &&
                                            isset($data->categoryClassificationId) &&
                                            (strtolower($data->categoryClassificationId->name) != \App\Product::CATEGORY_KULIAH_NAME)
                                        )
                                            <a href="{{ route('admin.product.kartupeserta.preview', [$data->slug]) }}" title="Kartu Peserta" class="btn btn-sm btn-peserta pull-right ml-5" target="_blank">
                                                Kartu Peserta
                                            </a>
                                        @endif
                                        @if (
                                            ...
                                            <a href="{{ route('admin.product.e-certificate.preview', [$data->slug]) }}" title="E-Certificate" class="btn btn-sm btn-info pull-right" target="_blank">
                                                E-Certificate
                                            </a>
                                        @endif
                                    </td>
